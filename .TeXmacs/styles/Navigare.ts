...
<\body>
  <\active*>
    <\src-title>
      <src-style-file|Navigare|0.8>

      <\src-purpose>
        Scrittura di saggi e manuali su formato in-quarto strutturato
      </src-purpose>
  ...
  <assign|page-odd-shift|5mm>

  <assign|page-even-shift|-5mm>

  <assign|page-width-margin|true>

  <assign|par-width|160mm>

  \;

  <assign|page-type|In quarto>

  <assign|page-width|250mm>

  <assign|page-height|350mm>

  \;

  <assign|page-top|25mm>

  <assign|page-bot|35mm>
  ...
  <assign|doc-title|<macro|x|<\surround|<vspace*|0.5fn>|<vspace|0.8fn>>
    <doc-title-block|<font-magnify|1.8|<doc-title-name|<arg|x>>>>
  </surround>>>

  <assign|doc-subtitle|<macro|x|<\surround|<vspace*|0.25fn>|<vspace|0.5fn>>
    <doc-title-block|<font-magnify|1.0|<doc-title-name|<with|font-shape|italic|<arg|x>>>>>
  </surround>>>
